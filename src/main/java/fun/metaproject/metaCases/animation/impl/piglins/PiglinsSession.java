...
class PiglinsSession extends AnimationSession {
    ...
    public PiglinsSession(MetaCasesFree plugin, Player p, Location caseLoc, CaseModel caseModel, ConfigurationSection config) {
                    ...
                    while(var1.hasNext()) {
                        ...
                        if (!other.getUniqueId().equals(pig.getUniqueId())) {
                            ...
                            if (sim != null && HologramBridge.isAvailable()) {
                                ...
                                String hn = "metacase_sim_" + var10000 + "_" + other.getLocation().getBlockX() + "_" + other.getLocation().getBlockZ() + "_" + System.currentTimeMillis();
