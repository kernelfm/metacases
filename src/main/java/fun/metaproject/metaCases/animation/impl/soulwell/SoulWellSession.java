...
class SoulWellSession extends AnimationSession {
    ...
    private int ticks = 0;
    public SoulWellSession(MetaCasesFree plugin, Player p, Location caseLoc, CaseModel caseModel, ConfigurationSection config) {
                    ...
                    while(var1.hasNext()) {
                        ...
                        if (!s.equals(clickedStand)) {
                            ...
                            if (sim != null && HologramBridge.isAvailable()) {
                                ...
                                String hn = "metacase_sim_" + var10000 + "_" + sLoc.getBlockX() + "_" + sLoc.getBlockZ() + "_" + System.currentTimeMillis();
